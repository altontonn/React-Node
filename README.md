...
# 📖 [React Node] <a name="about-project"></a>

**[React-Node]** is a small react project which connects ReactJs with NodeJs.
...
Feel free to check the [issues page](https://github.com/altontonn/React-Node/issues/).
